...
export default function Home() {
  return (
    <main className="flex gap-8 min-h-screen py-8 2xl:py-24 px-8 bg-gradient-to-r from-white to-[#F3EEEA]">
